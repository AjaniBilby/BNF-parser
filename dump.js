class Wasm_SyntaxNode{constructor(type,start,end,count){this.type=type;this.start=start;this.end=end;this.count=count;this.value=[];this.ref=null;}}
function InitParse(ctx, data) {
    ...
    while (root === null || stack.length > 0) {
        ...
        const next = new Wasm_SyntaxNode(type, readBoundary ? memoryArray.at(offset + OFFSET.START / 4) || 0 : -1, readBoundary ? memoryArray.at(offset + OFFSET.END / 4) || 0 : -1, memoryArray.at(offset + OFFSET.COUNT / 4) || 0);
