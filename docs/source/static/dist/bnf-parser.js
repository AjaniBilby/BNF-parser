    ...
    m.addFunction("_matchString", binaryen.createType([binaryen.i32, binaryen.i32, binaryen.i32]), binaryen.i32, [
        ...
        m.block("outer", [
            m.loop("loop", m.block(null, [
                ...
                m.br_if("outer", m.i32.ge_s(m.i32.add(m.local.get(input, binaryen.i32), m.local.get(count, binaryen.i32)), m.global.get("heap", binaryen.i32))),
                m.br("loop")
            ]))
        ]),
